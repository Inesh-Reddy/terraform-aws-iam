...
variable "tags" {
  default     = { "GithubRepo" = "https://github.com/infracloudio/terraform-aws-iam" }
  description = "Map of tags to be applied to all resources."
  type        = map(string)
}

variable "additional_policy_enabled" {
  default     = true
  description = "Flag to enable/disable the creation of Additional policy"
  type        = bool
}


variable "additional_policy_file" {
  type = string
}
